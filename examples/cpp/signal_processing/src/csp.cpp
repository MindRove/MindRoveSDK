...
int main (int argc, char *argv[])
{
    ...
    MindRoveArray<double, 1> labels (labels_array, n_ep);
    MindRoveArray<double, 3> data (data_array, n_ep, n_ch, n_times);
    std::cout << data << std::endl;

    std::pair<MindRoveArray<double, 2>, MindRoveArray<double, 1>> output =
