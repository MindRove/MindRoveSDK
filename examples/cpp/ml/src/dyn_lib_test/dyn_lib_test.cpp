...
int prepare (void *custom, struct MindRoveModelParams *params)
{
    return (int)MindRoveExitCodes::STATUS_OK;
}
    ...
    struct MindRoveModelParams *params)
{
    ...
    {
        return (int)MindRoveExitCodes::INVALID_ARGUMENTS_ERROR;
    }
...
int release (struct MindRoveModelParams *params)
{
    return (int)MindRoveExitCodes::STATUS_OK;
}