...
extern "C"
{
    ...
    SHARED_EXPORT int CALLING_CONVENTION get_board_data_count (
        int *result, int board_id, const char *json_mindrove_input_params);
    SHARED_EXPORT int CALLING_CONVENTION get_board_data (
        int data_count, double *data_buf, int board_id, const char *json_mindrove_input_params);
    ...
    SHARED_EXPORT int CALLING_CONVENTION insert_marker (
        double marker_value, int board_id, const char *json_mindrove_input_params);
